...
func TestSetupAutoPath(t *testing.T) {
	...
	}{{`autopath @kubernetes`, false, "", "kubernetes", nil, ""}, {`autopath example.org @kubernetes`, false, "example.org.", "kubernetes", nil, ""}, {`autopath 10.0.0.0/8 @kubernetes`, false, "10.in-addr.arpa.", "kubernetes", nil, ""}, {`autopath ` + resolv, false, "", "", []string{"bar.com.", "baz.com.", ""}, ""}, {`autopath kubernetes`, true, "", "", nil, "open kubernetes: no such file or directory"}, {`autopath`, true, "", "", nil, "no resolv-conf"}}
