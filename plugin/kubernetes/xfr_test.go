...
func TestEndpointsEquivalent(t *testing.T) {
	...
	epB := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foo"}}}}}
	epC := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.5", Hostname: "foo"}}}}}
	epD := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.5", Hostname: "foo"}}}, {Addresses: []object.EndpointAddress{{IP: "1.2.2.2", Hostname: "foofoo"}}}}}
	epE := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.5", Hostname: "foo"}, {IP: "1.1.1.1"}}}}}
	epF := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foofoo"}}}}}
	epG := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foo"}}, Ports: []object.EndpointPort{{Name: "http", Port: 80, Protocol: "TCP"}}}}}
	epH := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foo"}}, Ports: []object.EndpointPort{{Name: "newportname", Port: 80, Protocol: "TCP"}}}}}
	epI := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foo"}}, Ports: []object.EndpointPort{{Name: "http", Port: 8080, Protocol: "TCP"}}}}}
	epJ := object.Endpoints{Subsets: []object.EndpointSubset{{Addresses: []object.EndpointAddress{{IP: "1.2.3.4", Hostname: "foo"}}, Ports: []object.EndpointPort{{Name: "http", Port: 80, Protocol: "UDP"}}}}}
	tests := []struct {
		equiv	bool
		a	*object.Endpoints
		b	*object.Endpoints
	}{{true, &epA, &epB}, {false, &epA, &epC}, {false, &epA, &epD}, {false, &epA, &epE}, {false, &epA, &epF}, {false, &epF, &epG}, {false, &epG, &epH}, {false, &epG, &epI}, {false, &epG, &epJ}}
