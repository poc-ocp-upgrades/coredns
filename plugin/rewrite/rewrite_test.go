...
func TestRewrite(t *testing.T) {
	...
	rules = append(rules, r)
	rw := Rewrite{Next: plugin.HandlerFunc(msgPrinter), Rules: rules, noRevert: true}
	tests := []struct {
		from	string
		fromT	uint16
		fromC	uint16
		...
		toT	uint16
		toC	uint16
	}{{"from.nl.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"a.nl.", dns.TypeA, dns.ClassINET, "a.nl.", dns.TypeA, dns.ClassINET}, {"a.nl.", dns.TypeA, dns.ClassCHAOS, "a.nl.", dns.TypeA, dns.ClassINET}, {"a.nl.", dns.TypeANY, dns.ClassINET, "a.nl.", dns.TypeHINFO, dns.ClassINET}, {"from.nl.", dns.TypeANY, dns.ClassINET, "to.nl.", dns.TypeANY, dns.ClassINET}, {"from.exact.nl.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"prefix.nl.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"to.suffix.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"from.substring.nl.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"from.regex.nl.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"consul.rocks.", dns.TypeA, dns.ClassINET, "to.nl.", dns.TypeA, dns.ClassINET}, {"a.nl.", dns.TypeANY, dns.ClassCHAOS, "a.nl.", dns.TypeANY, dns.ClassINET}, {"a.nl.", dns.TypeANY, 4, "a.nl.", dns.TypeANY, dns.ClassINET}, {"core.dns.rocks.nl.", dns.TypeA, dns.ClassINET, "dns.core.rocks.nl.", dns.TypeA, dns.ClassINET}}
	ctx := context.TODO()
	for i, tc := range tests {
		m := new(dns.Msg)
...
func TestRewriteEDNS0Local(t *testing.T) {
	...
	tests := []struct {
		...
		toOpts		[]dns.EDNS0
		doBool		bool
	}{{[]dns.EDNS0{}, []string{"local", "set", "0xffee", "0xabcdef"}, []dns.EDNS0{&dns.EDNS0_LOCAL{Code: 0xffee, Data: []byte{0xab, 0xcd, 0xef}}}, false}, {[]dns.EDNS0{}, []string{"local", "append", "0xffee", "abcdefghijklmnop"}, []dns.EDNS0{&dns.EDNS0_LOCAL{Code: 0xffee, Data: []byte("abcdefghijklmnop")}}, false}, {[]dns.EDNS0{}, []string{"local", "replace", "0xffee", "abcdefghijklmnop"}, []dns.EDNS0{}, true}, {[]dns.EDNS0{}, []string{"nsid", "set"}, []dns.EDNS0{&dns.EDNS0_NSID{Code: dns.EDNS0NSID, Nsid: ""}}, false}, {[]dns.EDNS0{}, []string{"nsid", "append"}, []dns.EDNS0{&dns.EDNS0_NSID{Code: dns.EDNS0NSID, Nsid: ""}}, true}, {[]dns.EDNS0{}, []string{"nsid", "replace"}, []dns.EDNS0{}, true}}
	ctx := context.TODO()
	for i, tc := range tests {
		m := new(dns.Msg)
...
func TestEdns0LocalMultiRule(t *testing.T) {
	...
	tests := []struct {
		fromOpts	[]dns.EDNS0
		toOpts		[]dns.EDNS0
	}{{nil, []dns.EDNS0{&dns.EDNS0_LOCAL{Code: 0xffee, Data: []byte("fedcba")}}}, {[]dns.EDNS0{&dns.EDNS0_LOCAL{Code: 0xffee, Data: []byte("foobar")}}, []dns.EDNS0{&dns.EDNS0_LOCAL{Code: 0xffee, Data: []byte("abcdef")}}}}
	ctx := context.TODO()
	for i, tc := range tests {
		m := new(dns.Msg)
		m.SetQuestion("example.com.", dns.TypeA)
