...
func TestSetupDnssec(t *testing.T) {
	...
	}{{`dnssec`, false, nil, nil, false, defaultCap, ""}, {`dnssec example.org`, false, []string{"example.org."}, nil, false, defaultCap, ""}, {`dnssec 10.0.0.0/8`, false, []string{"10.in-addr.arpa."}, nil, false, defaultCap, ""}, {`dnssec example.org {
				cache_capacity 100
			}`, false, []string{"example.org."}, nil, false, 100, ""}, {`dnssec cluster.local {
				key file Kcluster.local
			}`, false, []string{"cluster.local."}, nil, false, defaultCap, ""}, {`dnssec example.org cluster.local {
				key file Kcluster.local
			}`, false, []string{"example.org.", "cluster.local."}, nil, false, defaultCap, ""}, {`dnssec example.org {
				key file Kcluster.local
			}`, true, []string{"example.org."}, nil, false, defaultCap, "can not sign any"}, {`dnssec example.org {
				key
			}`, true, []string{"example.org."}, nil, false, defaultCap, "argument count"}, {`dnssec example.org {
				key file
			}`, true, []string{"example.org."}, nil, false, defaultCap, "argument count"}, {`dnssec
		  dnssec`, true, nil, nil, false, defaultCap, ""}, {`dnssec cluster.local {
				key file Kcluster.local
