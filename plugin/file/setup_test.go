...
func TestFileParse(t *testing.T) {
	...
	tests := []struct {
		...
		expectedZones	Zones
			...
			}`, true, Zones{}}, {`file`, true, Zones{}}, {`file ` + zoneFileName1 + ` miek.nl.`, false, Zones{Names: []string{"miek.nl."}}}, {`file ` + zoneFileName2 + ` dnssex.nl.`, false, Zones{Names: []string{"dnssex.nl."}}}, {`file ` + zoneFileName2 + ` 10.0.0.0/8`, false, Zones{Names: []string{"10.in-addr.arpa."}}}, {`file ` + zoneFileName1 + ` example.net. {
				upstream a
			}`, true, Zones{Names: []string{}}}, {`file ` + zoneFileName1 + ` example.net. {
				no_rebloat
			}`, true, Zones{Names: []string{}}}}
