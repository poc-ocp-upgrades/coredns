...
func doReverterTests(rules []Rule, t *testing.T) {
	...
	for i, tc := range tests {
		...
		m.Answer = tc.answer
		rw := Rewrite{Next: plugin.HandlerFunc(msgPrinter), Rules: rules, noRevert: tc.noRevert}
